...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen flex sm:flex-col justify-center sm:items-center px-4">
      <div className="sm:bg-white w-full max-w-4xl pt-28 sm:p-4 rounded-xl sm:rounded-3xl flex items-stretch gap-10 sm:shadow">
        {!confirmed && (
          <div className="sm:w-1/3 bg-[url(/images/bg-sidebar-mobile.svg)] sm:bg-[url(/images/bg-sidebar-desktop.svg)] h-auto absolute sm:relative top-0 left-0 right-0 flex justify-center sm:justify-start sm:flex-col sm:space-y-6 py-6 px-6 bg-no-repeat bg-bottom bg-cover sm:rounded-xl min-h-40">
            {steps.map((s, index) => (
                      ...
                      <li key={plan.name}>
                        ...
                        >
                          ...
                          <Image
                            width={50}
                            height={50}
                            src={`/images/icon-${plan.name.toLowerCase()}.svg`}
                            alt={`${plan.name} image`}
                          />
                          <div>
      ...
      <div className="attribution mt-8 fixed bottom-16 sm:bottom-0 left-0 right-0 py-4">
        Challenge by{" "}
